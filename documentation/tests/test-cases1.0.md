...
### [ ] PROF-007: Visualizzazione "I Miei Articoli" (Bozze, In Revisione, Pubblicati, Respinti)
...
- **Precondizioni:** Un utente è loggato. Un articolo è pubblicato.
- **Passi (Like):**
...
- **Passi (Commenti):**
    1.  Visualizzare l'articolo.
    2.  Scrivere un commento nel form e cliccare "Invia Commento".
    3.  Mettere like al proprio commento o a quello di un altro utente.
- **Risultato Atteso (Commenti):**
    1.  Il commento viene aggiunto alla lista dei commenti e salvato in Firestore (`articleComments`).
    2.  Il `commentCount` dell'articolo viene incrementato.
    3.  Avatar, nome utente e bandiera del commentatore sono corretti.
    4.  Il like al commento funziona come descritto per i like agli articoli (UI, conteggio, persistenza).
    5.  La modale "Persone a cui piace" per i commenti funziona.
...
## 5. Issue Tracker (`contribute.html`)

### [ ] ISSUE-001: Invio Nuova Issue (utente loggato)
...
### [ ] ISSUE-002: Upvote Issue (utente loggato)
...
### [ ] ISSUE-003: Filtro Issue (per tipo/stato)
