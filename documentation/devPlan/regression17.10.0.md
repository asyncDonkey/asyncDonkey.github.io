...
_(Le altre sezioni e task del devplan originale (C.2.4, C.3, C.5, AUTH, A, D, E, F) mantengono per ora lo stato e le priorità relative indicate nel devplan v3.17.10, ma verranno rivalutate dopo la risoluzione delle regressioni critiche. Le priorità indicate sopra in "Prossimi Passi Immediati" hanno la precedenza su tutto.)_
