...
* **Task AUTH.2: Semplificazione e Conferma Funzionalità Profilo Utente**
    * `[ ]` Sub-task AUTH.2.1: Rimuovere da `profile.html` e `js/profile.js` l'UI e la logica per la *modifica* di Nickname e Nazionalità. Questi campi saranno solo visualizzati.
...
* **Task AUTH.3: Miglioramenti Funzionali Pagina Profilo Utente (`profile.html`)**
    ...
    * `[ ]` Sub-task AUTH.3.4 (Opzionale/Idee Future - *se il tempo lo permette, scegliere 1-2 max*):
        ...
        * **Contatori Semplici:** Visualizzare data di registrazione. *Contatori di articoli/commenti richiedono query o aggregazioni più complesse, posticipare se non semplici da ottenere.*
        * **Badge/Achievements Semplici (Pilota):**
            ...
            * *Complessità da valutare attentamente prima di iniziare.*
