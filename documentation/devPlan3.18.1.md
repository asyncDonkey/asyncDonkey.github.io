...
- _(Altri sub-task di C.2 come da piano precedente v3.17.10 - non elencati qui per brevità, presumibilmente molti completati)_
...
_(Task AUTH.1, AUTH.2, AUTH.3.1, AUTH.3.2.1, AUTH.3.3 - [x] Stato da v3.17.10)_
_(AUTH.REGRESS-001 e AUTH.REGRESS-002 sono stati rinominati REGRESS-001 e REGRESS-002 e sono COMPLETATI)_
...
- [ ] Task D.9: Migliorare UX per Utente Non Registrato. (Priorità Media)
      _(Altri task D come da piano precedente v3.17.10 - non elencati qui per brevità)_
...
- [x] F.2.4.3.A.2 (Icone Portal Card Homepage).
      _(Altri task F come da piano precedente v3.17.10 - non elencati qui per brevità)_
