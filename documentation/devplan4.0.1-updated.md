...
✅ **Task D.9: Migliorare UX per Utente Non Registrato. (Priorità MEDIA)** *(Parzialmente Completato, Task D.9.6 completato il 22 Maggio 2025)*
...
    - ✅ **D.9.6 (Messaggio Interattivo Contribute - Form Invio Issue):** Migliorare il messaggio "login richiesto" nel form di invio issue in `contribute.html` per includere link diretti a `register.html` (con parametri `authAction`), simile a D.9.4. *(Completato il 22 Maggio 2025 - AthenaDev)*
...
        - ✅ **Sub-task AUTH.3.6.2: Nickname Dinamico - Icona Autore.** *(Completato (escluso header) il 22 Maggio 2025 - AthenaDev)*
...
    - `[P]` Restanti miglioramenti funzionali o di UI per la leaderboard. *(Inizieremo da qui nella prossima sessione)*
...
- *(Task D.9 è stato spostato nella sezione "MIGLIORAMENTI STRUTTURALI E UI/UX" e D.9.6 è COMPLETATO)*
