...
- **Backend & Database (BaaS - Backend as a Service):**
    ...
    - **Firebase Platform:**
        ...
        - **Cloud Functions for Firebase (Node.js):** Serverless functions for backend logic triggered by Firestore events (e.g., updating user profiles based on game achievements or article publications). _(New)_
...
- **Key JavaScript Libraries & APIs:**
    ...
    - **Material Symbols (Google):** Modern icon library for UI elements. _(New)_
...
- **Development Tooling & Code Quality:**
    ...
    - **Firebase CLI & Emulator Suite:** For local development, testing of Cloud Functions and Firestore rules, and deployment. _(New)_
